...
//    // ---- infra ----
//
//    protected def hIn             : InD  = shape.in0
//    private[this] val in1         : InI  = shape.in1
//
//    protected def hFactor        : InD  = shape.in2
//    protected def hMinFactor     : InD  = shape.in3
//    protected def hRollOff       : InD  = shape.in4
//    protected def hKaiserBeta    : InD  = shape.in5
//    protected def hZeroCrossings : InI  = shape.in6
//    protected def hOut            : OutD = shape.out
//
...
//    }
//
//    new MainInHandler(hIn, isProcess = true )
