...
FScape(-next) is (C)opyright 2001&ndash;2021 by Hanns Holger Rutz. All rights reserved.
This program is free software; you can redistribute it and/or modify it under the terms 
of the [GNU Affero General Public License](https://github.com/Sciss/FScape-next/raw/main/LICENSE) v3+.
...
The current version `v` is `"3.6.1"`.
...
The following [program](https://github.com/Sciss/FScape-next/blob/main/core/src/test/scala/de/sciss/fscape/ConstQTest.scala)
