...
//
//    val dm1         = BinaryOp(op = BinaryOp.Times, a = dIn, b = const(cli))
//    val dm2         = BinaryOp(op = BinaryOp.Times, a = bIn, b = const(cai))
...
//    val logOut      = ??? : Outlet[BufD]  // ZipWindow(size = const(fftSize)) -- input buffer!
